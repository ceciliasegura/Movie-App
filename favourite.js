...
//extraemos el userId de la autenticación y metemos el obtener resultados dentro de la funcion por la asincronia
const auth = getAuth();
auth.onAuthStateChanged(function (user) {
    ...
    const movies = getDocs(collection(db, "movies" + "-" + userId));
...
function deleteFavourite(divMovie, id) {
    ...
    deleteDoc(doc(db, "movies" + "-" + userId, id))
        .then(() => {
